...
interface QuantitySelectorTapeProps {
  isOpen: boolean;
  onClose: () => void;
  onContinue: (
    quantity: number,
...
const BUNDLES: readonly TapeBundle[] = [
  {
    id: "caja",
    quantity: 1,
    price: 149000,
...
export const QuantitySelectorTape = ({ isOpen, onClose, onContinue }: QuantitySelectorTapeProps) => {
            ...
            <div className="space-y-8">
              <div className="space-y-4 text-center">
                <h2 className="text-3xl md:text-4xl font-bold text-foreground leading-tight">
                  Elegí tu Pack Face Tape
                </h2>
                <p className="text-base text-muted-foreground leading-relaxed">
                  Cuantas más cajas, más eventos listos. Menos precio por caja.
                </p>
              </div>
...
export default QuantitySelectorTape;
