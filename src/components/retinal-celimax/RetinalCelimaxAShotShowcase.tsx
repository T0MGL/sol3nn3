...
import aShotImage from "@/assets/products/retinal-celimax/othersection.webp";

export const RetinalCelimaxAShotShowcase = () => {
  return (
...
export default RetinalCelimaxAShotShowcase;
