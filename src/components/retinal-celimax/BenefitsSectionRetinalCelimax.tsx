...
import { RETINAL_CELIMAX_BENEFITS } from "@/data/retinalCelimaxProduct";

const ICONS = {
  firm: ArrowTrendingUpIcon,
  texture: BeakerIcon,
  tolerance: ShieldCheckIcon,
  glow: SunIcon,
} as const;

export const BenefitsSectionRetinalCelimax = () => {
  return (
      ...
      <div className="container max-w-[1200px] mx-auto relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold px-4">
            Renovación celular sin la pelea
          </h2>
          <p className="text-lg md:text-xl text-muted-foreground font-light max-w-2xl mx-auto">
            Cuatro razones por las que el retinal le ganó al retinol clásico en las rutinas premium coreanas.
          </p>
        </motion.div>
        ...
        >
          {RETINAL_CELIMAX_BENEFITS.map((benefit) => {
...
export default BenefitsSectionRetinalCelimax;
