...
import { RETINAL_CELIMAX_FAQS } from "@/data/retinalCelimaxProduct";

export const FAQSectionRetinalCelimax = () => {
  return (
    <section className="py-8 md:py-16 px-4 md:px-6 bg-background">
      <div className="container max-w-[900px] mx-auto">
        ...
        <Accordion type="single" collapsible className="space-y-4">
          {RETINAL_CELIMAX_FAQS.map((faq, index) => (
            <AccordionItem
              key={faq.q}
              value={`item-${index}`}
...
export default FAQSectionRetinalCelimax;
