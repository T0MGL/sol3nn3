...
const benefits = [
  ...
  },
  {
    ...
    description:
      "A diferencia del bimatoprost (Latisse), no contiene análogos de prostaglandinas. Cero riesgo de cambio de color en el iris ni oscurecimiento del párpado. SkinSAFE 91, libre del 91% de los alérgenos comunes.",
  },
  {
    icon: BeakerIcon,
    title: "Ginseng rojo y helichrysum",
    description:
      "Extracto de raíz de ginseng coreano y flor mediterránea de helichrysum. Los activos botánicos clave en serums de pestañas premium, en una fórmula al alcance de Paraguay.",
  },
  {
    icon: EyeIcon,
    title: "Apto lentes de contacto",
    description:
      "Aplicación nocturna en la base de la pestaña. Esperá 2 a 3 minutos a que seque antes de cerrar los ojos. A la mañana podés ponerte lentes y maquillarte normal.",
  },
];

export const BenefitsSectionSerum = () => {
  return (
      ...
      <div className="container max-w-[1200px] mx-auto relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold px-4">
            La pestaña tuya, en su mejor versión
          </h2>
          <p className="text-lg md:text-xl text-muted-foreground font-light max-w-2xl mx-auto">
            Nada de extensiones pegadas, nada de receta médica. Tu propia pestaña, más larga, más densa y más sana.
          </p>
        </motion.div>
...
export default BenefitsSectionSerum;
