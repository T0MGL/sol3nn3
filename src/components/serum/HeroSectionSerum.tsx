...
interface HeroSectionSerumProps {
  onBuyClick: () => void;
}

const HERO_STOCK_STORAGE_KEY = "solenne-serum-stock";

const SINGLE_BUNDLE = SERUM_BUNDLES[0];

export const HeroSectionSerum = ({ onBuyClick }: HeroSectionSerumProps) => {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-start overflow-hidden bg-background">
          ...
          >
            ...
            <div className="space-y-2">
              <p className="text-sm md:text-base text-foreground/70 leading-relaxed">
                Acondicionador de pestañas con ginseng rojo coreano y helichrysum. Fortalece la fibra desde la raíz para que tus pestañas crezcan más largas, más densas y sin quebrarse. Una sola pasada por noche en la base de la pestaña.
              </p>
              <p className="text-xs md:text-sm text-primary font-medium">
                Frasco 7 ml · Rinde 2 a 3 meses · Resultado pleno entre semanas 8 y 12
              </p>
            </div>

            <div className="flex items-center gap-3 py-2">
              <span className="text-base text-foreground/40 line-through">
                Gs. {SINGLE_BUNDLE.anchorPrice.toLocaleString("es-PY")}
              </span>
              <span className="text-4xl md:text-5xl font-bold text-foreground">
                Gs. {SINGLE_BUNDLE.totalPrice.toLocaleString("es-PY")}
              </span>
            </div>
            ...
            <div className="space-y-3">
              ...
              >
                <Button
                  ...
                  onClick={onBuyClick}
                >
                  COMPRAR AHORA: Gs. {SINGLE_BUNDLE.totalPrice.toLocaleString("es-PY")}
                </Button>
              </motion.div>
      ...
      <LivePurchaseNotification
        ...
        productLabel="el Serum de Pestañas"
      />
    </section>
  );
};

export default HeroSectionSerum;
