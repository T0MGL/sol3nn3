...
const stats: Stat[] = [
  {
    value: 91,
    suffix: " SkinSAFE",
    label: "Libre del 91% de alérgenos",
    description: "Clasificación verificada Mayo Clinic",
  },
  {
    value: 12,
    suffix: " sem",
    label: "Resultado pleno",
    description: "Cambios visibles entre la 4ta y 6ta",
  },
  {
    value: 0,
    suffix: "",
    label: "Prostaglandinas",
    description: "Sin riesgo de oscurecer el párpado",
  },
  {
    value: 3,
    suffix: " meses",
    label: "Por frasco de 7 ml",
    description: "Aplicación diaria, dura el tratamiento",
  },
];
...
export const StatsSectionSerum: React.FC = () => {
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <motion.div className="text-center mb-12 md:mb-16" {...fadeInUpView}>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
            Lo que la fórmula dice, sin adornos
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Datos verificados contra el INCI de BIOAQUA y SkinSAFE de Mayo Clinic.
          </p>
        </motion.div>
...
export default StatsSectionSerum;
