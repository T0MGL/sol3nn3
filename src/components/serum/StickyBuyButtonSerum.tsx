...
interface StickyBuyButtonSerumProps {
  onBuyClick: () => void;
}

const SINGLE_BUNDLE = SERUM_BUNDLES[0];

export const StickyBuyButtonSerum = ({ onBuyClick }: StickyBuyButtonSerumProps) => {
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
              ...
              <div className="flex items-center gap-4 text-xs text-muted-foreground">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="whitespace-nowrap">Frasco sellado o reemplazo</span>
                </div>
              </div>
            </div>
...
export default StickyBuyButtonSerum;
