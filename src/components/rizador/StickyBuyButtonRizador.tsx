...
interface StickyBuyButtonRizadorProps {
  onBuyClick: () => void;
}

export const StickyBuyButtonRizador = ({ onBuyClick }: StickyBuyButtonRizadorProps) => {
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
              <div>
                <p className="text-xs md:text-sm text-muted-foreground">
                  <span className="line-through text-foreground/40">Gs. 209.000</span>{" "}
                  <span className="text-xl md:text-2xl font-bold text-foreground ml-2">Gs. 159.000</span>
                </p>
              ...
              <div className="flex items-center gap-4 text-xs text-muted-foreground">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="whitespace-nowrap">Garantia de reemplazo</span>
                </div>
              </div>
            </div>
...
export default StickyBuyButtonRizador;
