...
interface GuaranteeSectionRizadorProps {
  onBuyClick: () => void;
}

export const GuaranteeSectionRizador = ({ onBuyClick }: GuaranteeSectionRizadorProps) => {
  return (
        ...
        >
          ...
          <div className="space-y-4 md:space-y-6">
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tighter px-4">
              Si llega con algun defecto, te enviamos otro
            </h2>
            <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground font-light px-4">
              Tu compra esta protegida. Sin letra chica.
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto space-y-6 md:space-y-8 py-4 md:py-8">
            <p className="text-base md:text-lg text-foreground/80 leading-relaxed font-light px-4">
              Cada rizador sale de nuestro deposito revisado y probado. Si llega dañado, con algun defecto de fabrica o no funciona correctamente, avisanos por WhatsApp en las primeras 24 horas desde la entrega y te enviamos uno nuevo sin cargo.
            </p>
...
export default GuaranteeSectionRizador;
