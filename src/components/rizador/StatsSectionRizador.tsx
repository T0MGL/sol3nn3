...
const stats: Stat[] = [
  ...
  },
  {
    value: 24,
    suffix: "H",
    label: "Duracion del rizado",
    description: "Todo el dia sin retoques",
  },
  {
    value: 31,
    suffix: "g",
    label: "Peso ultraligero",
    description: "Cabe en cualquier cartera",
  },
  {
    value: 0,
    suffix: "",
    label: "Tirones o daño",
    description: "Tecnologia termica gentil",
  },
];
...
export const StatsSectionRizador: React.FC = () => {
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <motion.div className="text-center mb-12 md:mb-16" {...fadeInUpView}>
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Todo lo que necesitas saber sobre tu nuevo rizador.
          </p>
        </motion.div>
...
export default StatsSectionRizador;
