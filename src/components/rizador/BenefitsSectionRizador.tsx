...
const benefits = [
  {
    icon: CloudIcon,
    title: "Cero tirones dolorosos",
    description:
      "El calor controlado moldea tus pestañas con suavidad, sin presionar ni tirar. Nada de pellizcos ni incomodidad como con el rizador de metal tradicional.",
  },
  {
    icon: ClockIcon,
    title: "Ahorra tiempo valioso",
    description:
      "Se calienta en 5 segundos y forma las pestañas en un solo movimiento. Tu rutina de maquillaje gana minutos cada mañana.",
  },
  {
    icon: HandRaisedIcon,
    title: "Portatil, llevalo donde quieras",
    description:
...
export const BenefitsSectionRizador = () => {
  return (
      ...
      <div className="container max-w-[1200px] mx-auto relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold px-4">
            Por que vas a amar este rizador
          </h2>
          <p className="text-lg md:text-xl text-muted-foreground font-light max-w-2xl mx-auto">
            Cuatro razones para dejar atras el rizador de metal y los tirones dolorosos.
          </p>
        </motion.div>
...
export default BenefitsSectionRizador;
