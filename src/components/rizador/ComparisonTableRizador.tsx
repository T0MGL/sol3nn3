...
const comparisons = [
  {
    title: "Rizador de metal tradicional",
    specs: [
      { label: "Moldeado", value: "Operacion repetida, lento", isGood: false },
      { label: "Duracion del rizado", value: "2 horas", isGood: false },
      { label: "Seguridad", value: "Pellizca los parpados y daña las pestañas", isGood: false },
      { label: "Confort", value: "Puramente manual, sin temperatura", isGood: false },
    ],
  },
  {
    title: "Otro rizador electrico de metal",
    specs: [
      { label: "Moldeado", value: "Calentamiento 15 seg, repetir para dar forma", isGood: false },
      { label: "Duracion del rizado", value: "8 horas", isGood: false },
      { label: "Seguridad", value: "Operacion frecuente, efecto no ideal", isGood: false },
      { label: "Confort", value: "Necesita pilas, reemplazo frecuente", isGood: false },
    ],
  },
  {
    title: "Rizador Solenne",
    specs: [
      { label: "Moldeado", value: "5 segundos, un solo movimiento", isGood: true },
      { label: "Duracion del rizado", value: "24 horas", isGood: true },
      { label: "Seguridad", value: "Anti-quemaduras, apagado inteligente a los 5 min", isGood: true },
      { label: "Confort", value: "Carga USB, 1 hora para todo el dia", isGood: true },
    ],
    isHighlighted: true,
  },
];

export const ComparisonTableRizador = () => {
...
export default ComparisonTableRizador;
