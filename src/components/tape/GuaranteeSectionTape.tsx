...
interface GuaranteeSectionTapeProps {
  onBuyClick: () => void;
}

export const GuaranteeSectionTape = ({ onBuyClick }: GuaranteeSectionTapeProps) => {
  return (
        ...
        >
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground font-light px-4">
              Si llega dañada o mal sellada, te mandamos otra sin costo.
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto space-y-6 md:space-y-8 py-4 md:py-8">
            <p className="text-base md:text-lg text-foreground/80 leading-relaxed font-light px-4">
              Cada caja sale de nuestro depósito sellada y revisada. Si llega dañada, mal sellada o con algún defecto, avisanos por WhatsApp en las primeras 24 horas desde la entrega y te enviamos una nueva sin cargo.
            </p>
...
export default GuaranteeSectionTape;
