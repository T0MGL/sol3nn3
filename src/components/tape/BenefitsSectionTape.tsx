...
const benefits = [
  ...
  {
    icon: FaceSmileIcon,
    title: "Compatible con tu maquillaje",
    description:
      "Aplicalo primero, y seguí tu rutina normal: base, polvo, rubor, contour. La cinta se integra bajo el maquillaje como si no estuviera.",
  },
];

export const BenefitsSectionTape = () => {
  return (
...
export default BenefitsSectionTape;
