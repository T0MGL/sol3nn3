...
interface StickyBuyButtonTapeProps {
  onBuyClick: () => void;
}

export const StickyBuyButtonTape = ({ onBuyClick }: StickyBuyButtonTapeProps) => {
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
              <div>
                <p className="text-xs md:text-sm text-muted-foreground">
                  ...
                  <span className="text-xl md:text-2xl font-bold text-foreground ml-2">Gs. 129.000</span>
                </p>
              ...
              <div className="flex items-center gap-4 text-xs text-muted-foreground">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="whitespace-nowrap">Caja sellada o la reemplazamos</span>
                </div>
              </div>
            </div>
...
export default StickyBuyButtonTape;
