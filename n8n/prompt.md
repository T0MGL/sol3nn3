...
- Accion default (lista GENERAL): Enviar imagen `lista_precios.jpg` + texto:
    ...
    1 caja 100u: Gs. 129.000
    Pack Ritual (2 cajas): Gs. 209.000
    Pack Evento (3 cajas): Gs. 299.000
...
- Accion: Enviar foto `face_tape_demo.jpg` + texto:
    ...
    1 caja con 100 parches: Gs. 129.000
    Te gustaria probarla?
    ```
...
if (productType === "tape") {
  const TAPE_PACK_PRICES = { 1: 129000, 2: 209000, 3: 299000 };
...
### Cross-sell pricing
- TAPE como cross-sell de SERUM: 79.000 Gs (en lugar de 129.000)
